...
namespace EsportsManager.Data.Migrations
{
    ...
    [Migration("20250527152122_Migration14")]
            ...
            modelBuilder.Entity("EsportsManager.EsportsManager.Data.Models.GameState", b =>
                {
                    ...
                    b.HasOne("EsportsManager.EsportsManager.Data.Models.Organization", "UserOrg")
                        .WithMany()
                        .HasForeignKey("UserOrgId")
                        .OnDelete(DeleteBehavior.SetNull);
